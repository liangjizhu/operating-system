/* Este programa sirve como ejemplo del uso de threads con par�metros
...
printf ("Inicio ejecuci�n del thread\n");
i=*((int *)(arg));
j=*((int *)(arg)+1);
k=*((int *)(arg)+2);
...
//f(argu);
 ...
 //Puedes probar a crearlo DETACHED y esperar con un sleep aunque es peor opci�n
